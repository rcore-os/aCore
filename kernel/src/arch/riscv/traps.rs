...
extern "C" fn trap_handler(_tf: &mut TrapFrame) {
    ...
    match scause.cause() {
        ...
        Trap::Exception(E::InstructionPageFault) => handle_page_fault(stval, MMUFlags::EXECUTE),
        Trap::Exception(E::LoadPageFault) => handle_page_fault(stval, MMUFlags::READ),
        Trap::Exception(E::StorePageFault) => handle_page_fault(stval, MMUFlags::WRITE),
